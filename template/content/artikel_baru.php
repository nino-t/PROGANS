...
<div id="content" class="site-content">
    ...
    <div class="container main-content-area content">
        <form action="<?php echo URL::Current() ?>" method="POST" class="" role="form" enctype="multipart/form-data">
                <input type="hidden" name="act" value="<?php echo $act ?>">
                <input type="hidden" name="id" value="<?php echo $article_id ?>">
                <div class="form-group">
                	<?php if (isset($errorCaptcha) || isset($uploadError)): ?>
	                	<div class="alert">
                ...
                <div class="form-group">
                    ...
                    <?php endif ?>
                    <small class="help-block">Upload Gambar Sebagai Cover</small>
                </div>
                ...
                <div class="form-group" id="inputkab">
                    ...
                    <select name="kabupaten" id="kabupaten" onchange="chain_combobox2()" class="form-control" required></select>
                	<small class="help-block">Silakan Pilih Kabupaten</small>
                </div>

				<div class="form-group">
					<label for="lokasi_tempat">Lokasi Tempat</label>
					<small class="help-block">Tandai Dengan Klik 2x Pada Peta Untuk Menandai</small>
					<input type="hidden" name="latitude" value="<?php echo $latitude ?>">
					<input type="hidden" name="longitude" value="<?php echo $longitude ?>">
					<div id="googleMaps" class="col-lg-12" style="height:500px"><span style="margin: 20px 0px 0px 50px;">Peta Tidak Termuat Cek Konektivitas Internet Anda</span></div>
				</div>
